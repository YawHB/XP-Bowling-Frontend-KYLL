      ...
      <div className=" mx-auto py-4 max-w-screen-full">
        <div className="flex flex-wrap">
          ...
          <Link to={`/barSale`} className="w-full md:w-1/2 md:pl-4 flex justify-center">
            <button
              className=" w-28 text-lg font-bold text-white whitespace-nowrap bg-green-500 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 border-2 border-yellow-300"
              id="startSale"
            >
              Start Salg
            </button>

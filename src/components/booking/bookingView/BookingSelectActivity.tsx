      ...
      <div>
        ...
        <div className="flex justify-between mt-8 mb-8">
          <button
            ...
            className="w-36 mr-4 p-2 text-lg font-bold text-white whitespace-nowrap bg-green-500 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 border-2 border-yellow-300"
          >
            Bowling
          </button>
          <button

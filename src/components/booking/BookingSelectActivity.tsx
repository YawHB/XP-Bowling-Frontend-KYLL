...
// export default function BookingSelectActivity() {
...
//         <h1>Vælg aktivitet</h1>
//         <div>
//           <button onClick={handleClick} value="bowling" className="bg-blue-500 p-2 m-2">
//             Bowling
//           </button>
//           <button onClick={handleClick} value="airHockey" className="bg-blue-500 p-2 m-2">
//             Air Hockey
//           </button>
//           <button onClick={handleClick} value="kidsBowling" className="bg-blue-500 p-2 m-2">
//             Børne Bowling
//           </button>
//           <button onClick={handleClick} value="restaurant" className="bg-blue-500 p-2 m-2">
//             Restaurant
//           </button>
//         </div>
//       </div>
